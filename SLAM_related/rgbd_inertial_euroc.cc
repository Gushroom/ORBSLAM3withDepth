...
void LoadImages(const string &strPathLeft, const string &strPathDepth, const string &strPathTimes,
...
int main(int argc, char **argv)
{
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        string pathCam0 = pathSeq + "/mav0/rgb/";
        string pathCam1 = pathSeq + "/mav0/depth/";
        string pathImu = pathSeq + "/mav0/imu0/data.csv";

        LoadImages(pathCam0, pathCam1, pathTimeStamps, vstrImageLeft[seq], vstrImageDepth[seq], vTimestampsCam[seq]);
        cout << "LOADED!" << endl;
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        {
            // Read left and Depth images from file
